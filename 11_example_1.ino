...
#define _DUTY_MAX 2250 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  {
    float distratio = (dist_ema - _DIST_MIN) / (_DIST_MAX - _DIST_MIN);
    myservo.writeMicroseconds(_DUTY_MIN + (int)((_DUTY_MAX - _DUTY_MIN) * distratio));
  }
